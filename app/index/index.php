...
<html lang="en">
  ...
  <head>
    ...
    <meta property="twitter:title" content="Modulos Emergentes">
    <meta property="twitter:description" content="Modulos Emergentes">

    <!-- Bootstrap core CSS -->
    <link href="../../recursos/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="../../assets/css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="../../assets/css/animate.min.css">
    <link rel="stylesheet" href="../../assets/css/easy-responsive-tabs.min.css">
    ...
    <!-- Style Propio -->
    <link rel="stylesheet" href="../../assets/css/stylo_global.css">

    <style>
      .spinner {
        border: 8px solid rgba(0, 0, 0, 0.1); border-top: 8px solid #333; border-radius: 50%; width: 100px; height: 100px; animation: spin 1s linear infinite; margin: 10px auto;
      }
      .spinner-sm {
        border: 5px solid rgba(0, 0, 0, 0.1); border-top: 5px solid #333; border-radius: 50%; width: 50px; height: 50px; animation: spin-sm 1s linear infinite; margin: 10px auto;
      }
      .spinner-xs {
        border: 4px solid rgba(0, 0, 0, 0.1); border-top: 4px solid #333; border-radius: 50%; width: 25px; height: 25px; animation: spin-xs 1s linear infinite; margin: 10px auto;
      }
      @keyframes spin { 0% { transform: rotate(0deg); }  100% { transform: rotate(360deg); } }
      @keyframes spin-sm { 0% { transform: rotate(0deg); }  100% { transform: rotate(360deg); } }
      @keyframes spin-xs { 0% { transform: rotate(0deg); }  100% { transform: rotate(360deg); } }
    ...
    line-height: 60px; /* Ajusta la altura de línea según tus necesidades */
      ...
      header {
    height: 50px; /* Ajusta la altura del encabezado según tus necesidades */
      }
...
<body>
  ...
  <div class="row">
    ...
    <!-- :::::::::::::::::: O F E R T A S   S E M A N A L E S  :::::::::::::: -->


    <!-- :::::::::::::::::: E X P E R I E N C I A S  E X C L U S I V A S :::::::::::::: -->
    <div class="col-lg-12">
  ...
  <footer>
    ...
    <ul class="social_icon">
      <a href="https://www.facebook.com/pages/UNAC-Medell%C3%ADn/207359105944833" target="_blank" rel="noopener noreferrer">
      ...
      <a href="https://www.tiktok.com/@madretierra.co/video/7241292478702161157?q=desarrollo%20sostenible&t=1699616394508" target="_blank" rel="noopener noreferrer">
      ...
      <a href="https://www.instagram.com/cuidado_del_medio_ambiente_/" target="_blank" rel="noopener noreferrer">
      ...
      <a href="admin/vistas/loginn.php" target="_blank" rel="noopener noreferrer">
        <li class="icon intranet">
          <span class="tooltip">Intranet</span>
